#!/usr/bin/env bash
# Build the rules_tcl release archive and emit release notes.
...
#
# Args:
#   $1: tag name (e.g. 0.3.0). Must match VERSION in version.bzl.
#
# Side effects:
#   Writes rules_tcl-${TAG}.tar.gz to the current directory. This
